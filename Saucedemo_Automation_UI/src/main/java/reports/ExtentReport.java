...
public final class ExtentReport {
    ...
    public static void initReport() {
        if (Objects.isNull(extent)) {
            ...
            spark.config().setDocumentTitle("ON-PASSIVE - TEST AUTOMATION REPORT");
            spark.config().setReportName("O-TRIM-USER REPORT");
    ...
    public static void createTest(String testcaseName) {
        ...
        ExtentTest test = extent.createTest(testcaseName).assignDevice(System.getProperty("browserName")).
